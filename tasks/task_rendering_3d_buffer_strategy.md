...
- [ ] Add `InstanceSync` (uploading [WorldTransform](file:///d:/Codes/customized-godot/modules/ecs_core/entity_manager.h#109-110) and [ShaderData](file:///d:/Codes/customized-godot/modules/ecs_core/shader_data_system.cpp#42-45) to the GPU).
- [ ] Implement `FrustumCulling` integration (skipping GPU upload for off-screen entities).
...
- [ ] [ADD] `RenderingSystem::set_culling_enabled(bool)`
